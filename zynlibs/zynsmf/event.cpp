...
uint32_t Event::getTime() { return m_nTime; }

uint8_t Event::getType() { return m_nType; }

uint8_t Event::getSubtype() { return m_nSubtype; }

uint32_t Event::getSize() { return m_nSize; }

uint8_t* Event::getData() { return m_pData; }