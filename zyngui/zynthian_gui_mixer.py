...
class zynthian_gui_mixer(zynthian_gui_base.zynthian_gui_base):
	...
	def hide(self):
		if self.shown:
			...
			zynsigman.unregister(zynsigman.S_AUDIO_RECORDER, zynthian_audio_recorder.SS_ZCTRL_ARM, self.update_control_arm)
			zynsigman.unregister(zynsigman.S_AUDIO_RECORDER, zynthian_audio_recorder.SS_ZCTRL_STATUS, self.update_control_rec)
			zynsigman.unregister(zynsigman.S_AUDIO_PLAYER, zynthian_engine_audioplayer.SS_ZCTRL_STATUS, self.update_control_play)
			super().hide()
	...
	def build_view(self):
		...
		zynsigman.register(zynsigman.S_AUDIO_RECORDER, zynthian_audio_recorder.SS_ZCTRL_ARM, self.update_control_arm)
		zynsigman.register(zynsigman.S_AUDIO_RECORDER, zynthian_audio_recorder.SS_ZCTRL_STATUS, self.update_control_rec)
		zynsigman.register(zynsigman.S_AUDIO_PLAYER, zynthian_engine_audioplayer.SS_ZCTRL_STATUS, self.update_control_play)
