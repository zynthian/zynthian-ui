...
def set_midi_config():
	global preset_preload_noteon, midi_single_active_channel, midi_network_enabled, touchosc_enabled
	...
	touchosc_enabled=int(os.environ.get('ZYNTHIAN_MIDI_TOUCHOSC',0))
