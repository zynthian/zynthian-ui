    ...
    def fill_list(self):
        ...
        def append_port(idev):
            ...
            if self.midi_input:
                ...
                input_mode_info = f"\n\nICONS KEY:\n"
                input_mode_info += f"{ZMIP_ICON_MODE_ACTIVE} Active mode\n"
