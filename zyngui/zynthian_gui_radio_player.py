...
class zynthian_gui_radio_player(zynthian_gui_selector):
	
	sys_dir = os.environ.get('ZYNTHIAN_SYS_DIR',"/zynthian/zynthian-sys")
	mplayer_ctrl_fifo_path = "/tmp/mplayer-control"

	def __init__(self):
		self.capture_dir_sdc = os.environ.get('ZYNTHIAN_MY_DATA_DIR',"/zynthian/zynthian-my-data") + "/playlist"
		self.capture_dir_usb = os.environ.get('ZYNTHIAN_EX_DATA_DIR',"/media/usb0/playlist")
		self.current_record = None
		self.rec_proc = None
		self.play_proc = None

		super().__init__('Playlist Player', True)
