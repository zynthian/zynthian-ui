...
class zynthian_ctrldev_fostex_mixtab(zynthian_ctrldev_zynmixer):
    ...
    def refresh(self):
        ...
        for chain_id, chain in self.chain_manager.chains.items():
            if chain.zynmixer_proc and chain.zynmixer_proc.mixer_chan is not None and chain.zynmixer_proc.mixer_chan < 16:
                self.chan2chain[chain.zynmixer_proc.mixer_chan] = chain_id
