...
class zynthian_ctrldev_akai_midimix_alt(zynthian_ctrldev_zynmixer):
    ...
    driver_name = "ULTRAFUN Driver"
    driver_description = "An alternate driver for Akai MIDIMix that implement lots of absurd features!"
