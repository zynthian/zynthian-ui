...
class zynthian_engine_fluidsynth(zynthian_engine):
    ...
    def __init__(self, zyngui=None):
        ...
        self.command = "fluidsynth -a jack -m jack -g 1 -j {}".format(
            self.fs_options)
        self.command_prompt = "\n> "
    ...
    def set_preset(self, layer, preset, preload=False):
        ...
        midi_prg = preset[1][2]
        logging.debug("Set Preset => Layer: {}, SoundFont: {}, Bank: {}, Program: {}".format(
            layer.part_i, sfi, midi_bank, midi_prg))
    ...
    def setup_router(self, layer):
        if layer.part_i is not None:
            ...
            try:
                ...
                layer.part_i = i
                layer.jackname = "{}:((l|r)_{:02d}|fx_(l|r)_({:02d}|{:02d}))".format(
                    self.jackname, i, i*2, i*2+1)
    ...
    def set_layer_midi_routes(self, layer):
        if layer.part_i is not None:
            ...
            router_chan_cmd = "router_chan {0} {0} 0 {1}".format(
                midich, layer.part_i)
